...
public class ServerCuritiba extends UnicastRemoteObject implements RMIInterface{

    private static final long serialVersionUID = 1L;

    public ServerCuritiba() throws RemoteException {
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            Naming.rebind("//localhost/ServerCuritiba", new ServerCuritiba());
            System.err.println("Server Curitiba ready");
