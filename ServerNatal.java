...
public class ServerNatal extends UnicastRemoteObject implements RMIInterface{

    private static final long serialVersionUID = 1L;

    public ServerNatal() throws RemoteException {
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            Naming.rebind("//localhost/ServerNatal", new ServerNatal());
            System.err.println("Server Natal ready");
