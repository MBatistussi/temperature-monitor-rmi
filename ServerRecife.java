...
public class ServerRecife extends UnicastRemoteObject implements RMIInterface{

    private static final long serialVersionUID = 1L;

    public ServerRecife() throws RemoteException {
    ...
    public String recife(String city, int min, int max) throws RemoteException, InterruptedException{
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            Naming.rebind("//localhost/ServerRecife", new ServerRecife());
            System.err.println("Server Recife ready");
