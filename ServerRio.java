...
public class ServerRio extends UnicastRemoteObject implements RMIInterface{

    private static final long serialVersionUID = 1L;

    public ServerRio() throws RemoteException {
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            Naming.rebind("//localhost/ServerRio", new ServerRio());
            System.err.println("Server Rio ready");
